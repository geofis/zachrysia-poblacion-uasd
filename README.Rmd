...
```{r mapa_hexagonos_qr, echo=F, fig.cap='Área de estudio, según GoogleEarth', out.width='100%'}
knitr::include_graphics(paste(figuras, "qr-mapa.jpg", sep = '/'))
```

El mapa debería parecerse a éste:

```{r mapa_hexagonos, echo=F, fig.cap='Área de estudio, según GoogleEarth', out.width='100%'}
...
[Aquí tienes](https://docs.google.com/spreadsheets/d/1ojcDkMX7uO3dCnVA29JSlRakT7YP6kA9YJiH_BlChXs/edit?usp=sharing) dispones del enlace a la hoja de cálculo que va recibiendo los formularios rellenos, para fines de consulta.
