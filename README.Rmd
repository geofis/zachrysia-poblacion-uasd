...
Necesitamos aunque sea un mapa básico del área de estudio. Hemos construido un diseño de muestreo basado en hexágonos de la biblioteca H3 (de Uber), el cual puedes consultar [aquí](https://www.google.com/maps/d/u/0/edit?mid=1zmduHx1pqN-z9EDCJ7U5P_ah-Dowcus&usp=sharing). Este el código QR:
